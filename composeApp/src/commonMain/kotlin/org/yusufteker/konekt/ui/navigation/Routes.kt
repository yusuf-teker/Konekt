...
sealed class Routes(
    ...
    @Serializable
    data object TaskCreateScreen : Routes("TaskCreateScreen")
    @Serializable
    data object TaskDetailScreen : Routes("TaskDetailScreen")
    @Serializable
    data object TaskEditScreen : Routes("TaskEditScreen")
    @Serializable
